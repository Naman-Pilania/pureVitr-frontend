...
const BASE_URL = `https://apiuat.akosh.in/`;
const NLB_URL = `https://global-nlb-70a6410694abcbab.elb.ap-south-1.amazonaws.com:3006/`;
const SELF_CARE_URL = `https://selfcareuat.akosh.in/`;

export const environment = {
  webUrl: 'https://webuat.akosh.in',
  production: false,
  landingBaseHref: '/uat/',
  baseHref: '/web/uat/',
  ...
  x_api_key: 'KRv2cvw3uZ1ifn4rZbO8R7f01VzciCR73jdGCbXy',
